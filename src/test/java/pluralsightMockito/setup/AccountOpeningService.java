...
import pluralsightMockito.AccountRepository;
...
public class AccountOpeningService {
    ...
    public AccountOpeningStatus openAccount(String firstName, String lastName, String taxId, LocalDate dob) throws IOException {
        ...
        final BackgroundCheckResults backgroundCheckResults = backgroundCheckService.confirm(firstName, lastName, taxId, dob);
